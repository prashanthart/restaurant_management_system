    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/tryp/alogin.php">Signup</a>
          </li>
          <!-- <li class="nav-item">
            <a class="nav-link" href="/tryp/showsignup.php">showsignup</a>
          </li> -->
          <li class="nav-item">
            <a class="nav-link active" href="/tryp/alogin.php">Admin login</a>
          </li>
          <!-- <li class="nav-item">
            <a class="nav-link" href="/tryp/showsignup.php">showsignup</a>
          </li> -->
...
<div class="container">
    <h1 class="text-center mt-1">admin login</h1>
     <form action="/tryp/alogin.php" method="post" class="form-control mt-2 login" style="width:300px;margin:auto;">
     <div class="mb-3">
        <label class="form-label mx-1">Admin Name</label>
         <input class="form-control fc" type="text" name="lname" placeholder="name" autocomplete="off">
         </div>
         <div class="mb-3">
     ...
     <div style="text-align: center;">
       ...
       <a href="/tryp/alogin.php" class="btn btn-sm link mt-2" style="background-color: rgb(48, 165, 37);color:white;font-weight: bold;text-shadow: 0px -1px 1px black;">Create New Account</a>
     </div>
</div>
